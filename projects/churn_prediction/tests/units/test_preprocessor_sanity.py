...
def test_feature_engineering_and_preprocessor_fit_transform(X_y) -> None:
    """
    Testa se a combinação de feature engineering e pré-processamento funciona sem erros e retorna
    um array numérico adequado para treino de modelos. O teste faz o seguinte:
        - Aplica a feature engineering nas colunas.
        - Aplica o pré-processamento, tratamento de colunas yes/no, encoding, etc.
        - Verifica se o resultado é um array numérico sem valores infinitos ou NaN, e se o número
            de linhas é o mesmo do input.
