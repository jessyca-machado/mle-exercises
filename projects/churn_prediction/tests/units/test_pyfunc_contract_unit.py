...
def test_pyfunc_contract_returns_dataframe_with_y_pred_proba(X_y, X_example) -> None:
    """
    Testa se o contrato do pyfunc é respeitado, ou seja, se a função predict retorna um DataFrame
    com a coluna 'y_pred_proba' contendo as probabilidades previstas, e se essas probabilidades
